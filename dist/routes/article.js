...
router.get('/edit/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Article.findById(req.params.id)];
            case 1:
                article = _a.sent();
...
router.get('/:slug', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Article.findOne({ slug: req.params.slug })];
            case 1:
                article = _a.sent();
                if (article == null)
                    res.redirect('/');
...
router.put('/:id', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req;
                return [4 /*yield*/, Article.findById(req.params.id)];
            case 1:
                _a.article = _b.sent();
                next();
                return [2 /*return*/];
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Article.findByIdAndDelete(req.params.id)];
            case 1:
                _a.sent();
                res.redirect('/');
                return [2 /*return*/];
